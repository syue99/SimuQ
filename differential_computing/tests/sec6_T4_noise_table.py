...
ROWS = [
    ...
    ["kick gate error, 1q (Z-type)", "coh. exp(-iθZ) + incoh. Z-dephasing",
     "ε_1q = 1e-4  (best-guess)",
     "Evered et al. 2026 (arXiv:2604.25987); 1q ≈ 0",
     "single-qubit kick-insertion segments", "yes",
     "Z/phase-dominated (Doppler, |r'>), X≈0; magnitude best-guess"],
    ["kick gate error, 2q (Z-type)", "coh. exp(-iθZ) + incoh. Z-dephasing",
     "ε_2q = 1e-3  (best-guess)",
     "Evered et al. 2026 (arXiv:2604.25987)",
     "two-qubit (ZZ) kick-insertion segments", "yes",
